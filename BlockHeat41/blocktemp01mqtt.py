...
logging.info("Publishing message to topic, BlockInTemp")
ret=client.publish("BlockInTemp", temp1, qos=2)
logging.info("Published return: "+str(ret))
time.sleep(2)
logging.info("Publishing message to topic, BlockOutTemp")
ret=client.publish("BlockOutTemp", temp2, qos=2)
logging.info("Published return:"+str(ret))
time.sleep(2)
