...
while(True):
  ...
  device_folder1 = glob.glob(base_dir + '*27b3')[0]
  device_file1 = device_folder1 + '/w1_slave'
  device_folder2 = glob.glob(base_dir + '*1d4e')[0]
  device_file2 = device_folder2 + '/w1_slave'
  device_folder3 = glob.glob(base_dir + '*317a')[0]
  ...
  print "DMS Temp: ", (read_temp1())
  print "E119 Temp: ", (read_temp2())
  print "E501 Temp: ", (read_temp3())
  	
  time.sleep(1)
  
  try:
    cursor.execute("""INSERT INTO dms_temp 
        (date, time, dms_temp, E119_temp, E501_temp) 
	VALUES 
	(NOW(),NOW(),%s,%s,%s);""",
	(read_temp1(), read_temp2(), read_temp3()))
