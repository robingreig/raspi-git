...
$mintemp1 = "Minimum Irricana Outside Temperature Today = ";
...
$maxtemp1 = "Maximum Irricana Outside Temperature Today = ";
...
//$mintemp5 = "Minimum Carefree Temperature Today = ";
...
//$maxtemp5 = "Maximum Carefree Temperature Today = ";
...
$result = mysql_query("SELECT * from garage_temp ORDER BY date DESC, time DESC LIMIT 1");

//Table starting tag and header cells
//echo " <table style='width: 80%; text-align: left; margin-left: auto; margin-right: auto;' border='0' cellpadding='2' cellspacing='2'><tr><th>Date</th><th>Time</th><th>Outside Temp</th><th>Desk Temp</th></th><th>Ceiling Temp</th><th>Attic Temp</th><th>House Temp</th><th>Office Temp</th><th>Carefree Temp</th></tr>";
echo " <table style='width: 80%; text-align: left; margin-left: auto; margin-right: auto;' border='0' cellpadding='2' cellspacing='2'><tr><th>Date</th><th>Time</th><th>Outside Temp</th><th>Desk Temp</th></th><th>Ceiling Temp</th><th>Attic Temp</th><th>House Temp</th><th>Office Temp</th></tr>";
...
//   echo "<tr><td>" . $row['date'] . "</td><td>" . $row['time'] . "</td><td>" . $row['outside_temp'] . "</td><td>" . $row['desk_temp'] . "</td><td>" . $row['ceiling_temp'] . "</td><td>" . $row['attic_temp'] . "</td><td>" . $row['house_temp'] . "</td><td>" . $row['office_temp'] . "</td><td>" . $row['maple_house'] . "</td></tr>";
   echo "<tr><td>" . $row['date'] . "</td><td>" . $row['time'] . "</td><td>" . $row['outside_temp'] . "</td><td>" . $row['desk_temp'] . "</td><td>" . $row['ceiling_temp'] . "</td><td>" . $row['attic_temp'] . "</td><td>" . $row['house_temp'] . "</td><td>" . $row['office_temp'] . "</td></tr>";
}
//Table closing tag
echo "</table>";
