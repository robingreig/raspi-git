...
$mintemp1 = "Minimum Irricana Outside Temperature January 2016 = ";
//$mintemp2 = mysql_query("SELECT min(outside_temp),1 FROM garage_temp WHERE date=CURDATE()");
$mintemp2 = mysql_query("SELECT min(outside_temp),1 FROM garage_temp WHERE YEAR(date)=2016 AND MONTH(date)=1");
...
$maxtemp1 = "Maximum Irricana Outside Temperature January 2016 = ";
//$maxtemp2 = mysql_query("SELECT max(outside_temp) FROM garage_temp WHERE date=CURDATE()");
$maxtemp2 = mysql_query("SELECT max(outside_temp) FROM garage_temp WHERE YEAR(date)=2016 AND MONTH(date)=1");
...
$mintemp5 = "Minimum Maple Creek House Temperature January  = ";
//$mintemp6 = mysql_query("SELECT min(maple_house),1 FROM garage_temp WHERE date=CURDATE()");
$mintemp6 = mysql_query("SELECT min(maple_house),1 FROM garage_temp WHERE YEAR(date) = 2016 AND MONTH(date)=1");
...
$maxtemp5 = "Maximum Maple Creek House Temperature January = ";
//$maxtemp6 = mysql_query("SELECT max(maple_house) FROM garage_temp WHERE date=CURDATE()");
$maxtemp6 = mysql_query("SELECT max(maple_house) FROM garage_temp WHERE YEAR(date)=2016 AND MONTH(date)=1");
...
$result = mysql_query("SELECT * from garage_temp WHERE YEAR(date) = 2016 AND MONTH(date)=1 ORDER BY date ASC");
