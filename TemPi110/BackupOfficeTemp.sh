...
mysqldump -u robin -pMicr0s0ft office_temp | gzip > /home/robin/OfficeTempBackup/office_temp_backup.`date +%F.%H:%M`.tempi110.sql.gz
...
scp /home/robin/OfficeTempBackup/`ls -tp /home/robin/OfficeTempBackup/ | grep -v /$ | head -1` robin@raspi15.hopto.org:/home/robin/office_temp_backup/
