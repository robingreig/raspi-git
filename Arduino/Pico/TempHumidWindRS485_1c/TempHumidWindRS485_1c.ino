...
const char *topic1 = "pico2w/02/windSpd1"; // m/s
const char *topic2 = "pico2w/02/windSpd2";  // km/hr
const char *topic3 = "pico2w/02/windDir"; // Wind Direction in degrees
//const char *topic4 = "pico2w/02/humid2"; // Not used  
const char *topic5 = "pico2w/02/temp";
const char *topic6 = "pico2w/02/humid";  
