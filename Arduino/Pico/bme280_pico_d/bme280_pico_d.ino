...
/*****
 * bme280_pico_d from Random Nerd Tutorials who got it from Adafruit
...
const char *topic2 = "pico/00/bme280Hum";
const char *topic3 = "pico/00/bme280Baro";
...
void pubTemp() {
    ...
    Serial.println("ºC");
    dtostrf(temperatureC, 6, 2, tempChar);
