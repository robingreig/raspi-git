/* 
 *  TempHumidWindRS485_3c.ino
 *  Robin
 *  2025.10.01
 *  
 *  Using pico2w-03
 *  
 *  Trying to setup wifi and mqtt reconnect in case the pico looses connection
 *  
...
const char *topic4 = "pico2w//02/RSSI"; // WiFi Signal Strength
...
//    if (client.connect("ESP8266Client", mqttUser, mqttPassword )) {
    if (client.connect(client_id.c_str())) {
      ...
      client.publish("pico2w/02/RSSI", WiFiRSSI.c_str(), "-r");
      delay(500);
    } else {
