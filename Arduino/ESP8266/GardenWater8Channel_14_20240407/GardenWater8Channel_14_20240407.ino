...
/************************************************************************
  GardenWater8Channel_14_20240407
  Robin Greig, 2024.04.07
...
const char *switch01 = "esp8266/14/GPIO"; // MQTT subscribe topic for switch inputs
const char *battVolt = "esp8266/14/battVolt"; // MQTT publish topic for battery voltage
const char *outTemp = "esp8266/14/outTemp"; // MQTT publish topic for outside temperature
const char *battTemp = "esp8266/14/battTemp"; // MQTT publish topic for outside temperature
const char *rssi = "esp8266/14/RSSI"; // MQTT publish topic for signal RSSI
...
//    Serial.println("Just fed the main loop dog!");   
  ...
  if (currentMillis - mqttPreviousMillis >= mqttInterval) {
    ...
    Serial.print("Green/Red temp = battTemp = ");
    ...
    Serial.print("Silver temp = outTemp = ");
