...
/*
  GardenWater8Channel_03_20230820a
  Robin Greig, 2023.08.20
...
const char *battVolt = "esp8266/03/BATT"; // MQTT publish topic for battery voltage
const char *outTemp = "esp8266/03/OUT"; // MQTT publish topic for outside temperature
...
void loop()
{
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    client.publish(outTemp, temperatureChar,"-r"); //publish temp
  }
  client.loop();
