/******************************************************************************
 *    Filename: mqtt_ds18b20_double_DS_BattMon_14                              *
 *    Version: 1.0                                                            *
 *    Date: 07 April 2024                                                     *
 ...
 *    Send topic1 to esp8266/14/brownTemp which is the Brown DS18B20          *                                            
 *    Send topic2 to esp8266/14/greenTemp which is the Green DS18B20            *
 *    Send topic3 to esp8266/14/blueTemp which is the Blue DS18B20        *                                            
 *    Send topic4 to esp8266/14/OrangeTemp which is the Orange DS18B20          *
 *    Send topic5 to esp8266/14/RSSI
 *    Send topic6 to esp8266/14/battVolt
...
const char *topic1 = "esp8266/14/brownTemp";
...
const char *topic6 = "esp8266/14/battVolt";

const char *topic7 = "esp8266/14/mac";
