...
const char *ssid = "Raspi32"; // Enter your WiFi name 

const char *password = "P@55w0rd2025";  // Enter WiFi password 
...
const char *topic = "esp8266/18/GPIO04"; 

const char *rssi = "esp8266/18/RSSI";
