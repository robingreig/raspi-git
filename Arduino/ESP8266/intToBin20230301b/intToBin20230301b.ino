...
/*
  ...
  bitRead allows me to convert from a decimal number to the individual bit
*/
...
void loop()
{
  ...
  for (int num = 0; num < 256; num++){
    ...
    Serial.print("bitRead(num, 3): ");
    Serial.println(bitRead(num, 3));
    Serial.print("bitRead(num, 4): ");
    Serial.println(bitRead(num, 4));
    Serial.print("bitRead(num, 5): ");
    Serial.println(bitRead(num, 5));
    Serial.print("bitRead(num, 6): ");
    Serial.println(bitRead(num, 6));
    Serial.print("bitRead(num, 7): ");
    Serial.println(bitRead(num, 7));
    delay(500);
  }
}
