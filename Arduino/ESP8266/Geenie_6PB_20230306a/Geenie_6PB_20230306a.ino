...
/*
  8channelRelay_pSwitch02_20230303a
...
//    if (client.connect("ESP8266Client", mqttUser, mqttPassword )) {
    if (client.connect(client_id.c_str())) {
      ...
      client.subscribe("esp/pSwitch04"); // subscribe to mqtt channel
    } else {
