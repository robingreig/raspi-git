/*
  mqtt_PowerSwitch_20230226b
  Robin Greig, 2023.02.26
  ...
  *** Also will send RSSI back to esp/rssi when receiving an mqtt callback
  mqtt broker: mqtt21.local
  mqtt topic: esp/pSwitch01
  mqtt topic: esp/rssi, publish rssi to mqtt 
*/
...
//    if (client.connect("ESP8266Client", mqttUser, mqttPassword )) {
    if (client.connect(client_id.c_str())) {
      ...
      client.publish("esp/rssi", WiFiRSSI.c_str());
