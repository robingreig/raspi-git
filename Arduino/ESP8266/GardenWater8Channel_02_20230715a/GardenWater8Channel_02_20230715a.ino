...
/*
  ...
  And Publish Outside Temp on MQTT esp/outTemp
  And Publish Battery Temp on MQTT esp/battTemp
...
const char *battTemp = "esp/battTemp02"; // MQTT publish topic for battery temperature
