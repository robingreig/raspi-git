/*********
 * Filename: WindAnemometer_mqtt_00_01.ino
 * for ESP32
 * Robin Greig
 * 2025.02.01
 * Receives RS-485 data from wind direction module and sends it via mqtt esp32/00/speed
 * Also sends rssi to esp32/00/RSSI
...
//      if (client.connect(client_id.c_str(), mqtt_username, mqtt_password)) { 
    if (client.connect(client_id.c_str())) {
      ...
      client.publish("esp32/00/RSSI", rssiSignal, "-r");  
    } else {
