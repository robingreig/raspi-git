...
$result_dms = mysql_query("SELECT date, time, dms_temp from dms_temp ORDER BY date DESC, time DESC LIMIT 1008");
$result_e119 = mysql_query("SELECT date, time, E119_temp from dms_temp ORDER BY date DESC, time DESC LIMIT 1008");
$result_e501 = mysql_query("SELECT date, time, E501_temp from dms_temp ORDER BY date DESC, time DESC LIMIT 1008");
