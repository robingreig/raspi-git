...
//        if (fgets(buffer, 2, stdin) != NULL) {
	// puts will send the value of the buffer to stdout
//	  printf("\nBuffer Value from puts = ");
//	  puts(buffer);
//	}
	...
	// strcmp in case I want to pull differnt values?
////	if (strcmp(buffer, "A") == 0) {
//	  printf("Voltage variable: %f V\n", voltage);
//	  printf("%f V\n", voltage);
	// only returning voltage for serial05.py to work correctly
	  printf("%f\n", voltage);
////	}
