...
// set pin numbers:
const int buttonPin01 = A0;     // the number of input 01
const int ledPin01 =  13;      // the number of output 01 (LED_D5 pin)
const int buttonPin02 = A1;     // the number of input 02
const int ledPin02 =  9;      // the number of output 02 (LED_D6 pin)
const int buttonPin03 = A2;     // the number of input 03
const int ledPin03 =  10;      // the number of output 03 (LED_D7 pin)
const int buttonPin04 = A3;     // the number of input 04
const int ledPin04 =  3;      // the number of output 04 (LED_D8 pin)
const int buttonPin05 = A4;     // the number of input 05
const int ledPin05 =  5;      // the number of output 05 (LED_D9 pin)
const int buttonPin06 = A5;     // the number of input 06
const int ledPin06 =  6;      // the number of output 06 (LED_D10 pin)


// Variables will change:
int ledState01 = HIGH;         // the current state of output 01 pin
int buttonState01 = HIGH;      // the current reading from input 01 pin
int lastButtonState01 = LOW;   // the previous reading from input 01 pin
int ledState02 = HIGH;         // the current state of output 02 pin
int buttonState02 = HIGH;      // the current reading from input 02 pin
int lastButtonState02 = LOW;   // the previous reading from input 02 pin
int ledState03 = HIGH;         // the current state of output 03 pin
int buttonState03 = HIGH;      // the current reading from input 03 pin
int lastButtonState03 = LOW;   // the previous reading from input 03 pin
int ledState04 = HIGH;         // the current state of output 04 pin
int buttonState04 = HIGH;      // the current reading from input 04 pin
int lastButtonState04 = LOW;   // the previous reading from input 04 pin
int ledState05 = HIGH;         // the current state of output 05 pin
int buttonState05 = HIGH;      // the current reading from input 05 pin
int lastButtonState05 = LOW;   // the previous reading from input 05 pin
int ledState06 = HIGH;         // the current state of output 06 pin
int buttonState06 = HIGH;      // the current reading from input 06 pin
int lastButtonState06 = LOW;   // the previous reading from input 06 pin

// the following variables are long's because the time, measured in miliseconds,
// will quickly become a bigger number than can be stored in an int.
long lastDebounceTime01 = 0;  // the last time output pin 01 was toggled
long debounceDelay01 = 50;    // the debounce time; increase if the output flickers
long lastDebounceTime02 = 0;  // the last time output pin 02 was toggled
long debounceDelay02 = 50;    // the debounce time; increase if the output flickers
long lastDebounceTime03 = 0;  // the last time output pin 03 was toggled
long debounceDelay03 = 50;    // the debounce time; increase if the output flickers
long lastDebounceTime04 = 0;  // the last time output pin 04 was toggled
long debounceDelay04 = 50;    // the debounce time; increase if the output flickers
long lastDebounceTime05 = 0;  // the last time output pin 05 was toggled
long debounceDelay05 = 50;    // the debounce time; increase if the output flickers
long lastDebounceTime06 = 0;  // the last time output pin 06 was toggled
