...
$voltage1 = " = ";
$voltage11 = mysql_query("SELECT date, min(voltage1) from voltages WHERE date=(CURDATE()-1)");
...
$voltage2 = " = ";
$voltage22 = mysql_query("SELECT date, min(voltage1) from voltages WHERE date=(CURDATE()-2)");
...
$voltage3 = " = ";
$voltage33 = mysql_query("SELECT date, min(voltage1) from voltages WHERE date=(CURDATE()-3)");
...
$voltage4 = " = ";
$voltage44 = mysql_query("SELECT date, min(voltage1) from voltages WHERE date=(CURDATE()-4)");
...
$voltage5 = " = ";
$voltage55 = mysql_query("SELECT date, min(voltage1) from voltages WHERE date=(CURDATE()-5)");
