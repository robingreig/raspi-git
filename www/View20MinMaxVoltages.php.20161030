...
echo " <table style='width: 80%; text-align: left; margin-left: auto; margin-right: auto;' border='0' cellpadding='2' cellspacing='2'><tr><th>Date</th><th>APRX Battery</th><th>Blue Truck</th></th><th>Grey Truck</th><th>Secondary (Orange)</th><th>Primary (Green)</th><th>12V-1 (Blue)</th><th>12V-2 (Brown)</th></tr>";
