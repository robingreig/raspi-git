...
# 2014.12.28 Had to change the date seperators from : to - to be able to save properly on FAT32 usb stick
...
scp -q /home/robin/mediadb_backup/`ls -tp /home/robin/mediadb_backup/ | grep -v /$ | head -1` /media/usb/mediadb_backup
...
scp -q /home/robin/raspi15_www_backup/`ls -tp /home/robin/raspi15_www_backup/ | grep -v /$ | head -1` robin@192.168.200.14:/home/robin/raspi15_www_backup/
scp -q /home/robin/raspi15_www_backup/`ls -tp /home/robin/raspi15_www_backup/ | grep -v /$ | head -1` /media/usb/raspi15_www_backup/
scp -q /home/robin/raspi15_www_backup/`ls -tp /home/robin/raspi15_www_backup/ | grep -v /$ | head -1` robin@192.168.200.16:/home/robin/raspi15_www_backup/
...
scp -q /home/robin/OfficeTempBackup/`ls -tp /home/robin/OfficeTempBackup/ | grep -v /$ | head -1` robin@192.168.200.14:/home/robin/office_temp_backup/
scp -q /home/robin/OfficeTempBackup/`ls -tp /home/robin/OfficeTempBackup/ | grep -v /$ | head -1` /media/usb/office_temp_backup/
scp -q /home/robin/OfficeTempBackup/`ls -tp /home/robin/OfficeTempBackup/ | grep -v /$ | head -1` robin@192.168.200.16:/home/robin/office_temp_backup/
