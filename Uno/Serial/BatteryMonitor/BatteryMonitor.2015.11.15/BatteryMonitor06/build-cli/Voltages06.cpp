...
//  Serial.println(sensorValue);
  ...
  if(sensorValue > 814) // 13.55VDC
    {
//    Serial.println("Voltage > 13.55VDC"); 
    digitalWrite(6,HIGH);
    digitalWrite(5,HIGH);
    digitalWrite(3,HIGH);
...
//    digitalWrite(8,LOW);
  ...
  // sensorValue of 814 = ((5/1023 * 814)+9.57)=13.05
    ...
    {
//    Serial.println("Voltage > 13.05VDC"); 
    digitalWrite(6,LOW);
    digitalWrite(5,HIGH);
    digitalWrite(8,HIGH);
    digitalWrite(3,HIGH);
...
//    digitalWrite(8,LOW);
  ...
  // sensorValue of 814 = ((5/1023 * 814)+9.57)=12.55
    ...
    {
//    Serial.println("Voltage > 12.55VDC"); 
    digitalWrite(6,LOW);
    digitalWrite(5,LOW);
    digitalWrite(8,HIGH);
    digitalWrite(3,HIGH);
...
//    digitalWrite(8,LOW);
  ...
  // sensorValue of 814 = ((5/1023 * 814)+9.57)=12.05
    ...
    {
//    Serial.println("Voltage > 12.05VDC"); 
    digitalWrite(6,LOW);
    digitalWrite(5,LOW);
    digitalWrite(8,LOW);
    digitalWrite(3,HIGH);
...
//    digitalWrite(8,LOW);
  ...
  // sensorValue of 814 = ((5/1023 * 814)+9.57)=11.55
    ...
    {
//    Serial.println("Voltage > 11.55VDC"); 
    digitalWrite(6,LOW);
    digitalWrite(5,LOW);
    digitalWrite(8,LOW);
    digitalWrite(3,LOW);
...
//    digitalWrite(8,LOW);
  ...
  // sensorValue of 814 = ((5/1023 * 814)+9.57)=11.05
    ...
    {
//    Serial.println("Voltage > 11.05VDC"); 
    digitalWrite(6,LOW);
    digitalWrite(5,LOW);
    digitalWrite(8,LOW);
    digitalWrite(3,LOW);
...
//    digitalWrite(8,LOW);
  ...
  // sensorValue of 814 = ((5/1023 * 814)+9.57)=10.55
    ...
    {
//    Serial.println("Voltage > 10.55VDC"); 
    digitalWrite(6,LOW);
    digitalWrite(5,LOW);
    digitalWrite(8,LOW);
    digitalWrite(3,LOW);
